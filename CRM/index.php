...
<?php
 include('require/header.php');
  ?>
                                ...
                                <div class="col-md-6 col-xl-3">
                                    <div class="mini-stat clearfix bg-white">
                                        ...
                                        <?php
                                          ...
                                          $del = $db->prepare('SELECT * FROM lead_form');
                                          $del->execute();
                                        ...
                                        <div class="mini-stat-info">
                                            <span class="counter text-purple" style="font-size:40px;"><?php echo "$count";?></span>
                                            <h4 class="mt-0 header-title">Total Number Of Leads</h4>
                                        </div>
                                ...
                                <div class="col-md-6 col-xl-3">
                                    <div class="mini-stat clearfix bg-white">
                                        ...
                                        <?php
                                          ...
                                          $del = $db->prepare('SELECT * FROM employee');
                                          $del->execute();
                                          // print("Return number of rows that were deleted:\n");
                                          $count = $del->rowCount();
                                          // print("Deleted $count rows.\n");
                                          ?>
                                        <div class="mini-stat-info">
                                            <span class="counter text-teal"style="font-size:40px;"><?php echo "$count";?></span>
                                           <h4 class="mt-0 header-title">Number Of Employes</h4>
                                        </div>
                                 ...
                                 <div class="col-md-6 col-xl-3">
                                    <div class="mini-stat clearfix bg-white">
                                        <span class="mini-stat-icon bg-orange mr-0 float-right"><i class=" mdi mdi-incognito"></i></span>
                                        <?php

                                          $del = $db->prepare('SELECT * FROM client');
                                          $del->execute();
                                          // print("Return number of rows that were deleted:\n");
                                          $count = $del->rowCount();
                                          // print("Deleted $count rows.\n");
                                          ?>
                                        <div class="mini-stat-info">
                                            <span class="counter text-orange"style="font-size:40px;"><?php echo "$count";?></span>
                                           <h4 class="mt-0 header-title">Number Of Clients</h4>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="text-center">
                                                <input class="knob" data-width="120" data-height="120" data-linecap=round
                                                       data-fgColor="#ffbb44" value="80" data-skin="tron" data-angleOffset="100"
               ...
               ?>
                       <script src=" <?php echo $sitename?>public/assets/pages/widget-init.js"></script>
