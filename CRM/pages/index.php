            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div class="small-box " style="background-color:#8258FA;">
                        <div class="inner">
                            <h3 style="color:white;"><?php
                                $sel = DB_NUM("SELECT * FROM `create_ads`");
                                $fsel = mysql_query(mysql_fetch_array($sel));
                                echo $sel;
                                ?></h3>
                ...
                <div class="col-md-3">
                    ...
                    <div class="small-box " style="background-color:green;">
                        <div class="inner">
                            <h3 style="color:white;"><?php
                                $sel = DB_NUM("SELECT * FROM `create_ads` WHERE `admin_status`='2' ");
                                $fsel = mysql_query(mysql_fetch_array($sel));
                                echo $sel;
                                ?></h3>
                ...
                <div class="col-md-3">
                    ...
                    <div class="small-box " style="background-color: crimson;">
                        <div class="inner">
                            <h3 style="color:white;"><?php
                                $sel = DB_NUM("SELECT * FROM `create_ads` WHERE `admin_status`='0' ");
                                $fsel = mysql_query(mysql_fetch_array($sel));
                                echo $sel;
                                ?></h3>
                ...
                <div class="col-md-3">
                    ...
                    <div class="small-box " style="background-color: deeppink;">
                        <div class="inner">
                            <h3 style="color:white;"><?php
                                $sel = DB_NUM("SELECT * FROM `create_ads` WHERE `admin_status`='1' ");
                                $fsel = mysql_query(mysql_fetch_array($sel));
                                echo $sel;
                                ?></h3>
                ...
                <div class="col-md-3">
                    ...
                    <div class="small-box " style="background-color: cadetblue;">
                        <div class="inner">
                            <h3 style="color:white;"><?php
                                $sel = DB_NUM("SELECT * FROM `create_ads` WHERE `adtype`='1' ");
                                $fsel = mysql_query(mysql_fetch_array($sel));
                                echo $sel;
                                ?></h3>
                ...
                <div class="col-md-3">
                    ...
                    <div class="small-box " style="background-color:blue">
                        <div class="inner">
                            <h3 style="color:white;"><?php
                                $sel = DB_NUM("SELECT * FROM `create_ads` WHERE `adtype`='2' ");
                                $fsel = mysql_query(mysql_fetch_array($sel));
                                echo $sel;
                                ?></h3>
                ...
                <!--            <div class="col-md-3">
                                ...
                                <div class="small-box" style="background-color:#D94E18;">
                                    <div class="inner">
                                        <h3 style="color:white;"><?php
                $sel = DB_NUM("SELECT  DISTINCT `chqno` FROM `cheque` WHERE `cancelled`!=1");
                $fsel = mysql_query(mysql_fetch_array($sel));
                echo $sel;
                ?></h3>
                                        <p>&nbsp;</p>
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="small-box"style="background-color:#F2B305;">
                        <div class="inner">
                            ...
                            <h3 style="color:white;">
                                <?php
                                $sel = DB_NUM("SELECT * FROM `create_ads` where `agent_id`='" . $_SESSION['UIDD'] . "' AND `status`='1'");
                                $fsel = mysql_query(mysql_fetch_array($sel));
                                $sel1 = $sel * 20;
                                echo $sel1;
                                ?>
                ...
                <div class="col-md-3">
                    ...
                    <div class="small-box " style="background-color:#8258FA;">
                        <div class="inner">
                            <h3 style="color:white;"><?php
                                $sel = DB_NUM("SELECT * FROM `create_ads` where `agent_id`='" . $_SESSION['UIDD'] . "'");
                                $fsel = mysql_query(mysql_fetch_array($sel));
                                echo $sel;
                                ?></h3>
                ...
                <div class="col-md-3">
                    ...
                    <div class="small-box " style="background-color:green;">
                        <div class="inner">
                            <h3 style="color:white;"><?php
                                $sel = DB_NUM("SELECT * FROM `create_ads` WHERE `admin_status`='2' AND `agent_id`='" . $_SESSION['UIDD'] . "'");
                                $fsel = mysql_query(mysql_fetch_array($sel));
                                echo $sel;
                                ?></h3>
                            <p style="color:white;">Un Approved Advertisements</p>
                ...
                <div class="col-md-3">
                    ...
                    <div class="small-box " style="background-color: darkcyan;">
                        <div class="inner">
                            <h3 style="color:white;"><?php
                                $sel = DB_NUM("SELECT * FROM `create_ads` WHERE `admin_status`='0' AND `agent_id`='" . $_SESSION['UIDD'] . "'");
                ...
                <div class="col-md-3">
                    ...
                    <div class="small-box " style="background-color: darkslateblue ;">
                        <div class="inner">
                            <h3 style="color:white;"><?php
                                $sel = DB_NUM("SELECT * FROM `create_ads` WHERE `admin_status`='1' AND `agent_id`='" . $_SESSION['UIDD'] . "'");
                                $fsel = mysql_query(mysql_fetch_array($sel));
                                echo $sel;
                                ?></h3>
                            <p style="color:white;">Approved Advertisements</p>
                ...
                <div class="col-md-3">
                    ...
                    <div class="small-box " style="background-color:blue;">
                        <div class="inner">
                            <h3 style="color:white;"><?php
                                $sel = DB_NUM("SELECT * FROM `create_ads` WHERE `adtype`='1' AND `agent_id`='" . $_SESSION['UIDD'] . "'");
                                $fsel = mysql_query(mysql_fetch_array($sel));
                                echo $sel;
                                ?></h3>
                            <p style="color:white;">Paid Advertisements</p>
                ...
                <div class="col-md-3">
                    ...
                    <div class="small-box " style="background-color: deeppink;">
                        <div class="inner">
                            <h3 style="color:white;"><?php
                                $sel = DB_NUM("SELECT * FROM `create_ads` WHERE `adtype`='2' AND `agent_id`='" . $_SESSION['UIDD'] . "'");
                                $fsel = mysql_query(mysql_fetch_array($sel));
                                echo $sel;
                                ?></h3>
                            <p style="color:white;">Free Advertisements</p>
