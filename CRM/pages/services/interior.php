...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
           Services Interior Mgmt
            <small>Interior Mgmt</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo $sitename; ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="#"><i class="fa fa-newspaper-o"></i> Home</a></li>
            <li class="active">Interior Mgmt</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><a href="<?php echo $sitename; ?>services/addinterior.htm">Add New</a></h3>
            </div>
            <div class="box-body">
                <?php echo $msg; ?>
                        ...
                        <table id="normalexamples" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center" width="10%" >content</th>
...
<script type="text/javascript">
    ...
    {
        var bid = a;
        window.location.href = '<?php echo $sitename; ?>services/' + a + '/editinterior.htm';
    }
</script>
<?php
...
<script type="text/javascript">
    $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=interiortable"
    });
</script>
