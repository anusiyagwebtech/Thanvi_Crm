    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><a href="<?php echo $sitename; ?>home/services/addservices.htm">Add New </a></h3>
            </div>
            <div class="box-body">
                <?php echo $msg; ?>
                        ...
                        <table id="normalexamples" class="table table-bordered table-striped">
                            <thead>
                                <tr>
									...
									<th width="25%">Lable Headind</th>
                                   <!--  <th style="text-align: center" width="10%" >Lable Content</th> -->
...
<script type="text/javascript">
    ...
    {
        var sid = a;
        window.location.href = '<?php echo $sitename; ?>services/' + a + '/editservices.htm';
    }
</script>
<?php
...
<script type="text/javascript">
    $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=servicestable"
    });
</script>
