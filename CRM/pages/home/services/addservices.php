...
if (isset($_REQUEST['submit'])) {
	...
	if ($getid != '') {
        ...
        $linkimge = $db->prepare("SELECT * FROM `services` WHERE `sid` = ? ");
    ...
    if ($ext != '1') {
        $msg = addservices1($heading, $lable1, $lable2, $imagetitle, $content, $order, $status, $ip, $getid);
    } else {
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo $sitename; ?>pages/home/services/services.htm">Services Mgmt</a></li>
            <li class="active"><?php
                if ($_REQUEST['sid'] != '') {
                    echo 'Edit';
                } else {
        ...
        <form method="post" autocomplete="off" enctype="multipart/form-data" action="">
            <div class="box box-info">
						...
						<!--	<div class="clearfix"><br /></div>
                           ...
                           <!--  <div class="row">  
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control spinner" <?php if (getnews('image', $_REQUEST['bid']) == '') { ?> required="required" <?php } ?> name="image" type="file"> 
                                    </div>
                                </div>
                                <?php if (getnews('image', $_REQUEST['nid']) != '') { ?>
                                    <div class="col-md-6 col-sm-6 col-xs-12" id="delimage">
                                        <label> </label>
                                        <img src="<?php echo $fsitename; ?>images/events/<?php echo getnews('image', $_REQUEST['nid']); ?>" style="padding-bottom:10px;" height="100" />
                                        <button type="button" style="cursor:pointer;" class="btn btn-danger" name="del" id="del" onclick="javascript:deleteimage('<?php echo getnews('image', $_REQUEST['nid']); ?>', '<?php echo $_REQUEST['nid']; ?>', 'news', '../../images/events/thump', 'image', 'nid');"><i class="fa fa-close">&nbsp;Delete Image</i></button>
                                    </div>
                                <?php } ?>
                            </div> -->
                            <div class="clearfix"><br /></div>
							<!-- <div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label>services content<span style="color:#FF0000;"> *</span></label>                                  
										 <textarea id="heading" name="heading" class="form-control" ><?php echo getnews('content', $_REQUEST['sid']); ?></textarea>
									</div>
								</div>
							</div> -->
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>lable Heading<span style="color:#FF0000;"> *</span></label>                                  
                                         <textarea id="lable1" name="lable1" class="form-control" ><?php echo getservices1('lable1', $_REQUEST['sid']); ?></textarea>
                                    </div>
                                </div>
                            </div>
							<div class="clearfix"><br /></div>
                            <div class="row">
                                <div class="col-md-12">
                                    <label> lable Content <span style="color:#FF0000;"></span></label>
                                    <textarea id="lable2" name="lable2" class="form-control" rows="5" cols="80"><?php echo getservices1('lable2', $_REQUEST['sid']); ?></textarea>
                                </div>
                            </div>
                            <div class="clearfix"><br /></div>
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" required="required " class="form-control" placeholder="Enter the Order" name="order" value="<?php echo getservices1('order', $_REQUEST['sid']); ?>">
                                </div>
                                <div class="col-md-6">
                                    <label>Status <span style="color:#FF0000;">*</span></label>                                  
                                    <select name="status" class="form-control">
                                        <option value="1" <?php
                                        if (getservices1('status', $_REQUEST['sid']) == '1') {
                                            echo 'selected';
                                        }
                                        ?>>Active</option>
                                        <option value="0" <?php
                                        if (getservices1('status', $_REQUEST['sid']) == '0') {
                                            echo 'selected';
                                        }
                                        ?>>Inactive</option>
                                    </select>
                ...
                <div class="box-footer">
                    <div class="row">
                        <div class="col-md-6">
                            <a href="<?php echo $sitename; ?>home/services/services.htm">Back to Listings page</a>
                        </div>
                        <div class="col-md-6">
