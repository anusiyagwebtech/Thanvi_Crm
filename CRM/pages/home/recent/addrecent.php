...
if (isset($_REQUEST['submit'])) {
	...
	if ($getid != '') {
        ...
        $linkimge = $db->prepare("SELECT * FROM `recent` WHERE `rid` = ? ");
    ...
    if ($imag) {
        if ($pimage != '') {			
            unlink("../../../images/recent/" . $pimage);
            unlink("../../../images/recent/thump/" . $pimage);
        }
        ...
        if (($extension == 'jpg') || ($extension == 'png') || ($extension == 'gif')) {
            $m = strtolower($imagec);
            $imagev = $m . "." . $extension;
            $thumppath = "../../../images/recent/";
            $thumppath1 = "../../../images/recent/thump/";
    ...
    if ($ext != '1') {
        $msg = addrecent1($content, $image, $imagealt, $imagetitle,$order, $status, $ip, $getid);
    } else {
    ...
    <section class="content-header">
        <h1>
            ...
            <small><?php
                ...
                ?> Recent Works Mgmt </small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo $sitename; ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="#"><i class="fa fa-newspaper-o"></i> Home</a></li>
            <li><a href="<?php echo $sitename; ?>pages/home/recent/recent.htm">Recent Mgmt</a></li>
            <li class="active"><?php
                if ($_REQUEST['rid'] != '') {
                    echo 'Edit';
                } else {
        ...
        <form method="post" autocomplete="off" enctype="multipart/form-data" action="">
            <div class="box box-info">
						...
						<!--	<div class="clearfix"><br /></div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea id="content" name="content" class="form-control" rows="5" cols="80"><?php echo getrecent1('content', $_REQUEST['rid']); ?></textarea>
                                </div>
                            </div>
                            <div class="clearfix"><br /></div>
                            ...
                            <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Image Name<span style="color:#FF0000;"> *</span></label>                                  
                                        <input type="text" name="imagetitle" pattern="[a-z0-9-_]{2,255}" title="Allowed Characters (a-z0-9-_){2,255})" placeholder="Enter the Image Name" class="form-control" value="<?php echo getrecent1('image_title', $_REQUEST['rid']); ?>" required />                     
                                    </div>
                                </div>       
                                 <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Image alt<span style="color:#FF0000;"> *</span></label>                                  
                                        <input type="text" name="imagealt" placeholder="Enter the Image alt" class="form-control" value="<?php echo getrecent1('image_alt', $_REQUEST['rid']); ?>" required />                     
                                    </div>
                                </div>                                           
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <label>Image <span style="color:#FF0000;"> *(Recommended Size 1000 Pixels Width * 1000 Pixels Height)</span></label>
                                        <input class="form-control spinner" <?php if (getrecent1('image', $_REQUEST['rid']) == '') { ?> required="required" <?php } ?> name="image" type="file"> 
                                    </div>
                                </div>
                                <?php if (getrecent1('image', $_REQUEST['rid']) != '') { ?>
                                    <div class="col-md-6 col-sm-6 col-xs-12" id="delimage">
                                        <label> </label>
                                        <img src="<?php echo $fsitename; ?>images/recent/<?php echo getrecent1('image', $_REQUEST['rid']); ?>" style="padding-bottom:10px;" height="100" />
                                        <button type="button" style="cursor:pointer;" class="btn btn-danger" name="del" id="del" onclick="javascript:deleteimage('<?php echo getrecent1('image', $_REQUEST['rid']); ?>', '<?php echo $_REQUEST['rid']; ?>', 'recent', '../../images/recent/thump', 'image', 'rid');"><i class="fa fa-close">&nbsp;Delete Image</i></button>
                                    </div>
                                <?php } ?>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" required="required " class="form-control" placeholder="Enter the Order" name="order" value="<?php echo getrecent1('order', $_REQUEST['rid']); ?>">
                                </div>
                                <div class="col-md-6">
                                    <label>Status <span style="color:#FF0000;">*</span></label>                                  
                                    <select name="status" class="form-control">
                                        <option value="1" <?php
                                        if (getrecent1('status', $_REQUEST['rid']) == '1') {
                                            echo 'selected';
                                        }
                                        ?>>Active</option>
                                        <option value="0" <?php
                                        if (getrecent1('status', $_REQUEST['rid']) == '0') {
                                            echo 'selected';
                                        }
                                        ?>>Inactive</option>
                                    </select>
                ...
                <div class="box-footer">
                    <div class="row">
                        <div class="col-md-6">
                            <a href="<?php echo $sitename; ?>home/recent/recent.htm">Back to Listings page</a>
                        </div>
                        <div class="col-md-6">
