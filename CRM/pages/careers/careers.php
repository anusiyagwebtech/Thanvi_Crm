...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Careers Mgmt
            <small>Manage Careers Mgmt</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo $sitename; ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="#"><i class="fa fa-graduation-cap"></i> Careers</a></li>
            <li class="active">Careers Mgmt</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><a href="<?php echo $sitename; ?>careers/addcareers.htm">Add New Careers </a></h3>
            </div>
            <div class="box-body">
                <?php echo $msg; ?>
...
<script type="text/javascript">
    ...
    {
        var sid = a;
        window.location.href = '<?php echo $sitename; ?>careers/' + a + '/editcareers.htm';
    }
</script>
<?php
...
<script type="text/javascript">
    $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=careertable"
    });
</script>
