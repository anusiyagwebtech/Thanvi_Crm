...
<script type="text/javascript" >
    ...
    function checkdelete(name)
    {
        ...
        {
            if (confirm("Please confirm you want to Delete this Fleet(s)"))
            {
                return true;
            }
            else
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Fleet
            <small>List of Fleet(s)</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo $sitename; ?>"><i class="fa fa-dashboard"></i>Dashboard</a></li>
            <li><a href="#"><i class="fa fa-asterisk"></i>Dynamic(s)</a></li>
            <li class="active"><a href="#"><i class="fa fa-circle-o"></i>Fleet Mgmt</a></li>            
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                ...
                <h3 class="box-title"><a href="<?php echo $sitename; ?>dynamic/addfleet.htm">Add New Fleet</a></h3>
            </div><!-- /.box-header -->
            <div class="box-body">
                <?php echo $msg; ?>
...
<script type="text/javascript">
    ...
    {
        var did = a;
        window.location.href = '<?php echo $sitename; ?>dynamic/' + a + '/editfleet.htm';
    }
</script>
<?php
...
<script type="text/javascript">
      $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=fleettable"
    });
</script>
