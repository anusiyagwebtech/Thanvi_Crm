...
<script type="text/javascript" >
    ...
    function checkdelete(name)
    {
        ...
        {
            if (confirm("Please confirm you want to Delete this Service(s)"))
            {
                return true;
            } else
            {
...
<style type="text/css">
    ...
    #normalexamples tbody tr td:nth-child(3),#normalexamples tbody tr td:nth-child(4),#normalexamples tbody tr td:nth-child(5),#normalexamples tbody tr td:nth-child(6),#normalexamples tbody tr td:nth-child(1),#normalexamples tbody tr td:nth-child(7) {
        text-align:center;
    }
</style>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Services Mgmt
            <small>Manage Services Mgmt</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo $sitename; ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="#"><i class="fa fa-asterisk"></i>Master(s)</a></li>
            <li class="active">Services Mgmt</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><a href="<?php echo $sitename; ?>master/addservices.htm">Add New Service </a></h3>
            </div>
            <div class="box-body">
                <?php echo $msg; ?>
...
<script type="text/javascript">
    ...
    {
        var sid = a;
        window.location.href = '<?php echo $sitename; ?>master/' + a + '/editservice.htm';
    }
</script>
<!--<script>
...
<script type="text/javascript">
    $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=servicetable"
    });
</script>