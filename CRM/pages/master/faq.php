...
<script type="text/javascript" >
    ...
    function checkdelete(name)
    {
        ...
        {
            if (confirm("Please confirm you want to Delete this FAQ(s)"))
            {
                return true;
            } else
            {
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            FAQ's Mgmt
            <small>Manage FAQ's Mgmt</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo $sitename; ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="#"><i class="fa fa-asterisk"></i> Masters</a></li>
            <li class="active">FAQ's Mgmt</li>
        </ol>
    </section>
