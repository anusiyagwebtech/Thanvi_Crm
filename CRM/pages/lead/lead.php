                                ...
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">Lead Management</h4>
                                        </div>
                                         <div class="col-md-6" >
                                             <button  onclick="window.location.href = '<?php echo $sitename; ?>pages/lead/addlead.php';" type="reset" class="btn btn-info waves-effect" style="float:right;margin-right:50px;">
                                 ...
                                 <form name="form1" method="post" action="">
                                    <button type="submit" style="float:right;margin:10px;" class="btn btn-danger" name="delete" id="delete" value="Delete" onclick="return checkdelete('chk[]');"><i class="mdi mdi-delete-forever"></i>&nbsp; DELETE </button>
...
<script type="text/javascript">
    ...
    {
        var lid = a;
        window.location.href = '<?php echo $sitename; ?>lead/' + a + '/editlead.htm';
    }
     function viewthis(a)
    {
        var lid = a;
        window.location.href = '<?php echo $sitename; ?>lead/' + a + '/viewlead.htm';
    }
</script>
...
<script type="text/javascript">
    $('#datatable').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=leadtable"
    });
</script>
