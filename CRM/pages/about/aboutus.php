    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><a href="<?php echo $sitename; ?>about/addaboutus.htm">Add New </a></h3>
            </div>
            <div class="box-body">
                <?php echo $msg; ?>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center" width="10%" >content1</th>
                                     <th style="text-align: center" width="10%" >list 1</th>
                                      <th style="text-align: center" width="10%" >list 2</th>
                                       <th style="text-align: center" width="10%" >list 3</th>
...
<script type="text/javascript">
    ...
    {
        var bid = a;
        window.location.href = '<?php echo $sitename; ?>about/' + a + '/editaboutus.htm';
    }
</script>
<?php
...
<script type="text/javascript">
    $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=aboutus1table"
    });
</script>
