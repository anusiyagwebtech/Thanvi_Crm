...
if (isset($_REQUEST['submit'])) {
	...
	if ($getid != '') {
        ...
        $linkimge = $db->prepare("SELECT * FROM `about_banner` WHERE `bid` = ? ");
    ...
    if ($ext != '1') {
        $msg = addbanner2($content1, $image, $imagealt, $imagename, $content, $order, $status, $ip, $getid);
    } else {
        ...
        <h1>
           About Banner Mgmt
            <small><?php
                ...
                ?>About Banner Mgmt </small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo $sitename; ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="#"><i class="fa fa-newspaper-o"></i> About</a></li>
            <li><a href="<?php echo $sitename; ?>pages/about/banner1.htm">>Banner Mgmt</a></li>
            <li class="active"><?php
                if ($_REQUEST['bid'] != '') {
                    echo 'Edit';
                } else {
        ...
        <form method="post" autocomplete="off" enctype="multipart/form-data" action="">
            <div class="box box-info">
                    ...
                    <div class="panel panel-info" id="comp_details_fields">
						...
						<!--	<div class="clearfix"><br /></div>
                            ...
                            <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Image Name<span style="color:#FF0000;"> *</span></label>                                  
                                        <input type="text" name="imagename" pattern="[a-z0-9-_]{2,255}" title="Allowed Characters (a-z0-9-_){2,255})" placeholder="Enter the Image Name" class="form-control" value="<?php echo getbanner2('image_name', $_REQUEST['bid']); ?>" required />                     
                                    </div>
                                </div>                                           
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <label>Image <span style="color:#FF0000;"> *(Recommended Size 1000 Pixels Width * 1000 Pixels Height)</span></label>
                                        <input class="form-control spinner" <?php if (getbanner2('image', $_REQUEST['bid']) == '') { ?> required="required" <?php } ?> name="image" type="file"> 
                                    </div>
                                </div>
                                <?php if (getbanner2('image', $_REQUEST['bid']) != '') { ?>
                                    <div class="col-md-6 col-sm-6 col-xs-12" id="delimage">
                                        <label> </label>
                                        <img src="<?php echo $fsitename; ?>images/banner/<?php echo getbanner2('image', $_REQUEST['bid']); ?>" style="padding-bottom:10px;" height="100" />
                                        <button type="button" style="cursor:pointer;" class="btn btn-danger" name="del" id="del" onclick="javascript:deleteimage('<?php echo getbanner2('image', $_REQUEST['bid']); ?>', '<?php echo $_REQUEST['bid']; ?>', 'banner', '../../images/banner/thump', 'image', 'bid');"><i class="fa fa-close">&nbsp;Delete Image</i></button>
                                    </div>
                                <?php } ?>
                            </div>
                            <div class="clearfix"><br /></div>
								...
								<div class="col-md-6">
									<div class="form-group">
										<label>Heading<span style="color:#FF0000;"> *</span></label>                                  
										 <textarea id="content1" name="content1" class="form-control" ><?php echo getbanner2('content1', $_REQUEST['bid']); ?></textarea>
									</div>
								</div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Content<span style="color:#FF0000;"> *</span></label>                                  
                                         <textarea id="content" name="content" class="form-control" ><?php echo getbanner2('content', $_REQUEST['bid']); ?></textarea>
                                    </div>
                                </div>
							</div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" required="required " class="form-control" placeholder="Enter the Order" name="order" value="<?php echo getbanner2('order', $_REQUEST['bid']); ?>">
                                </div>
                                <div class="col-md-6">
                                    <label>Status <span style="color:#FF0000;">*</span></label>                                  
                                    <select name="status" class="form-control">
                                        <option value="1" <?php
                                        if (getbanner2('status', $_REQUEST['bid']) == '1') {
                                            echo 'selected';
                                        }
                                        ?>>Active</option>
                                        <option value="0" <?php
                                        if (getbanner2('status', $_REQUEST['bid']) == '0') {
                                            echo 'selected';
                                        }
                                        ?>>Inactive</option>
                                    </select>
                ...
                <div class="box-footer">
                    <div class="row">
                        <div class="col-md-6">
                            <a href="<?php echo $sitename; ?>about/banner1.htm">Back to Listings page</a>
                        </div>
                        <div class="col-md-6">
