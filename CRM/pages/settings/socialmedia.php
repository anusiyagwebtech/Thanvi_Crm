...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#"><i class="fa fa-share-square"></i> Social Media</a></li>
                        ...
                        <table id="normalexamples" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th width="70%">Social Media </th>                                       
                                    <th style="text-align: center" width="10%" >Status</th>
                                    <th width="10%" data-sortable="false" align="center"  style="text-align: center">Edit</th>
                                </tr>
                            </thead>
                            <?php
