...
if (isset($_REQUEST['submit'])) {
    ...
    $msg = addhomeblocks($icon1, $title1, $content1, $status1, $icon2, $title2, $content2, $status2, $icon3, $title3, $content3, $status3, $icon4, $title4, $content4, $status4, $icon5, $title5, $content5, $status5, $icon6, $title6, $content6, $status6, $ip, $_SESSION['hid']);
}
?>
