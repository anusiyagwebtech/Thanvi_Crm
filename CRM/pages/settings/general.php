                        ...
                        <table class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: left" width="25%" >Heading</th>                                  
                                    <th style="text-align: left" width="20%" >Menu 1</th>
                                    <th style="text-align: left" width="20%" >Menu 2</th>
                                    <th style="text-align: left" width="20%" >Menu 3</th>
                                ...
                                <tbody>
                                    ...
                                    while ($fdepart = $ndepart->fetch()) {
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left"><?php echo $fdepart['heading1']; ?></td>
                                            <td style="text-align: left"><?php echo $fdepart['content1']; ?></td>
                                            <td style="text-align: left"><?php echo $fdepart['content2']; ?></td>
                                            <td style="text-align: left"><?php echo $fdepart['content3']; ?></td>
