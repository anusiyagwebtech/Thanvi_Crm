    ...
    <section class="content-header">
        <h1>
            ...
            <small><?php
                ...
                ?> ReCaptcha Mgmt</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo $sitename; ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="#" data-toggle="control-sidebar"><i class="fa fa-gears"></i> Settings</a></li>
            <li><a href="<?php echo $sitename; ?>settings/captcha.htm"><i class="fa fa-refresh"></i> ReCaptcha Mgmt </a></li>
            <li class="active"><?php
                if ($_REQUEST['cid'] != '') {
                    echo 'Edit';
                } else {
            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <div class="panel panel-info">
                        <div class="panel-heading">ReCaptcha Mgmt Details</div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <select name="status" id="status" required="required" class="form-control">
                                        <option value="1" <?php if (getcaptcha('status', $_REQUEST['cid']) == '1') { echo 'selected'; } ?>>Active</option>
                                        <option value="0" <?php if (getcaptcha('status', $_REQUEST['cid']) == '0') { echo 'selected'; } ?>>Inactive</option>
                                    </select>
                                </div>
                            </div>
                            <br />
