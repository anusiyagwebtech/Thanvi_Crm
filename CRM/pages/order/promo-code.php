...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Promo Codes
            <small>Manage  Promo Codes</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><a href="<?php echo $sitename; ?>order/add-promo-code.htm">Add  Promo Codes</a></h3>
            </div>
            <div class="box-body">
                <?php echo $msg; ?>
...
<script type="text/javascript">
    ...
    {
        var sid = a;
        window.location.href = '<?php echo $sitename; ?>order/' + a + '/edit-promo-code.htm';
    }
</script>
<?php
...
<script type="text/javascript">
    $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=promo_code"
    });
</script>