...
if ($_SERVER['HTTP_HOST'] == 'localhost') {
    ...
    $sitename = 'http://localhost/ttbilling/crm/';
    $fsitename = 'http://localhost/ttbilling/crm/';
    $actual_link = "http://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
    define('WEB_ROOT', $fsitename);
    $docroot = $_SERVER['DOCUMENT_ROOT'] . "/crm/";
} 
 else {
    $db = new PDO('mysql:host=localhost;dbname=crm;charset=utf8mb4', 'crm', 'crm');
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $db->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
    $connection_string = mysqli_connect("localhost", "crm", "crm", "crm");
    $sitename = "https://ttbilling.in/crm/";
    $site = 'https://ttbilling.in/crm/';
    $fsitename = 'https://ttbilling.in/crm/';
    $actual_link = "https://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
    define('WEB_ROOT', $fsitename);
    $docroot = $_SERVER['DOCUMENT_ROOT'] . '/';
} 
// else {
    // $db = new PDO('mysql:host=localhost;dbname=nbayjobs_adarsh;charset=utf8mb4', 'nbayjobs_adarsh', 'Uctn~QD{pAPf');
    // $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    // $db->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
    // $connection_string = mysqli_connect("localhost", "nbayjobs_adarsh", "Uctn~QD{pAPf", "nbayjobs_adarsh");
    // $sitename = "http://www.nbayjobs.com/adarsh/admin/";
    // $site = 'http://www.nbayjobs.com/adarsh/';
    // $fsitename = 'http://www.nbayjobs.com/adarsh/';
    // $actual_link = "https://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
    // define('WEB_ROOT', $fsitename);
    // $docroot = $_SERVER['DOCUMENT_ROOT'] . '/';
// }
