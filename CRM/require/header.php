                           ...
                           <!--  <div class="search-wrap" id="search-wrap">
                               ...
                               <!--  <li class="list-inline-item dropdown notification-list">
                                ...
                                <li class="list-inline-item dropdown notification-list">
                                    <a class="nav-link dropdown-toggle arrow-none waves-effect nav-user" data-toggle="dropdown" href="#" role="button"
                                       aria-haspopup="false" aria-expanded="false">
                                        <img src="<?php echo $sitename; ?>public/assets/images/users/avatar-1.jpg" alt="user" class="rounded-circle">
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                        ...
                                        <a class="dropdown-item" href="<?php echo $sitename . 'logout.php';?>"><i class="dripicons-exit text-muted"></i> Logout</a>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <ul class="list-inline menu-left mb-0">
                                ...
                                <li class="hide-phone list-inline-item app-search">
                                    <h3 class="page-title"><span style="color:#ffc800">Thanvi</span><span  style="color:#ff3446">Technologies</span>  CRM</h3>
                                </li>
                            </ul>
